...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PLAYERCONTEST_LIST actions', async () => {
    ...
    it('dispatches FETCH_PLAYERCONTEST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PLAYERCONTEST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PLAYERCONTEST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PLAYERCONTEST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PLAYERCONTEST actions', async () => {
      const expectedActions = [
        {
