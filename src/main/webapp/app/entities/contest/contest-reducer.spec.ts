...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './contest.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CONTEST_LIST actions', async () => {
    ...
    it('dispatches FETCH_CONTEST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CONTEST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CONTEST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CONTEST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CONTEST actions', async () => {
      const expectedActions = [
        {
