...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './game.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GAME_LIST actions', async () => {
    ...
    it('dispatches FETCH_GAME actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_GAME actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_GAME actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_GAME actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_GAME actions', async () => {
      const expectedActions = [
        {
