...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PLAYERGAME_LIST actions', async () => {
    ...
    it('dispatches FETCH_PLAYERGAME actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PLAYERGAME actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PLAYERGAME actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PLAYERGAME actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PLAYERGAME actions', async () => {
      const expectedActions = [
        {
