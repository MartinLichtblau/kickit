...
import de.mayflower.kickit.domain.Player;
import de.mayflower.kickit.domain.enumeration.Location;
import de.mayflower.kickit.repository.PlayerRepository;
...
class PlayerResourceIT {
    ...
    public static Player createEntity(EntityManager em) {
        Player player = new Player().name(DEFAULT_NAME).location(DEFAULT_LOCATION);
        return player;
    }
    ...
    public static Player createUpdatedEntity(EntityManager em) {
        Player player = new Player().name(UPDATED_NAME).location(UPDATED_LOCATION);
        return player;
    }
    ...
    void createPlayer() throws Exception {
        ...
        assertThat(testPlayer.getLocation()).isEqualTo(DEFAULT_LOCATION);
    }
    ...
    void putExistingPlayer() throws Exception {
        ...
        updatedPlayer.name(UPDATED_NAME).location(UPDATED_LOCATION);
        ...
        assertThat(testPlayer.getLocation()).isEqualTo(UPDATED_LOCATION);
    }
    ...
    void partialUpdatePlayerWithPatch() throws Exception {
        ...
        partialUpdatedPlayer.name(UPDATED_NAME).location(UPDATED_LOCATION);
